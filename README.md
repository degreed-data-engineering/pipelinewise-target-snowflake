...
| add_sdc_loaded_at_columns        | String  |            | (Default: False) When `add_sdc_loaded_at_columns` is enabled, an additional metadata column, _sdc_loaded_at, column will be included with a consistent timestamp of the entire extract/load.
